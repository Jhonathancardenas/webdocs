	...
	<div class="page-section gray-bg">
		<div class="container mt-40">
			...
			<div class="col-md-6">
				...
				<div class="form-group mb-30">
					<!-- <label>Your name *</label> -->
					<input type="text" value="" data-msg-required="Vehículo Particular ó Público" maxlength="100" class="controled" name="vehiculo_particular" id="vehiculo_particular" placeholder="Vehículo Particular ó Público" required>
