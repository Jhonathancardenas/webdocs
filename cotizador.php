...
<html lang="en">
	...
	<body>
            ...
            <div class="flex-container">
              <div class="flexslider loading">
                <ul class="slides">
                  ...
                  <!-- SLIDE 1 -->  
                  <li style="background:url(images/cotizadorp.jpg) no-repeat; background-position:50% 0">
                    <div class="container">
                      <div class="sixteen columns contain">
                        <h2 data-toptitle="48%" class="norm-43-wide text-center font-white caption-18-wide-767 flex-top-bot"><span class="slider-caption-border slider-caption-border-767">PRUEBA NUESTRO COTIZADOR</span></h2>
                      </div>
                    </div><!-- End Container -->
                  </li><!-- End item -->
        ...
        <iframe title="Cotizar Seguro" width="1500" height="500" src="http://agentemotor.com/cotizador-clientes-agencia?paramCode=eAMCtIU5rCVcqp7855e9aawmwnQbomUWsXNFrve57bPorxV0iTbiFqGvU35ZER20PqQKO70JiqWbv9RSZbtvIgXABiUZttxbCRXkS8GtLE0XsWDUBLacc2hNhVK92Ojx0_0dBe0khuLjr4LCRNQiKm0lXLvJk2Cm0wZUM2EoobAgI2YxUJt8s2SA1URyyb64ZJdX4Ipp9CYT6lqrR2IdY0ZNQ0DaXp4CE--CfIhNAgqGT3LAuGAEijcRFKWc4KZg3tW250Ny2vjuB1RjgyafLA54wpTLqlS3xgAHZtixWyKh3pROFPJutgyDKpiaN07jvTncTI96GQioQQh6K4tLvXVoLRwPPUg3AcyTgzdOFMRdUkHjRQdgJakyoevPOxHy&amp;PHPSESSID_VTIGER=ugtp2tdfup4ve360icau4utji1%22%20allowfullscreen=%22%22%20frameborder=%220%22%3E%3C/iframe%3E" frameborder="0"></iframe>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="cis-cont">
                  ...
                  <div class="cis-text">
                    <h3><span class="bold">DIRECCIÓN</span></h3>
                    <p>AV 19 N 125- 65 OFICINA 301 EDIFICIO AV 19</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="cis-cont">
                  ...
                  <div class="cis-text">
                    ...
                    <p><a href="mailto:rafael.perez@ageso.com">RAFAEL.PEREZ@AGESO.COM.CO</a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="cis-cont">
                  ...
                  <div class="cis-text">
                    <h3><span class="bold">LLÁMANOS</span></h3>
                    <p>313 831 13 65, 031 703 62 55</p>
                  </div>
                </div>
              </div>
