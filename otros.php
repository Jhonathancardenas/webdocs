...
<div id="wrap" class="boxed ">
                ...
                <div class="flex-container">
                    <div class="flexslider loading">
                        <ul class="slides">
                            ...
                            <!-- SLIDE 1 -->
                            <li style="background:url(images/otrosp.jpg) no-repeat; background-position:50% 0">
                                <div class="container">
                                    <div class="sixteen columns contain">
                                        <h2 data-toptitle="48%"
                                            class="norm-43-wide text-center font-white caption-18-wide-767 flex-top-bot">
                                            <span class="slider-caption-border slider-caption-border-767">OTROS SEGUROS</span>
                                        </h2>
                                    </div>
                                </div><!-- End Container -->
                            </li><!-- End item -->
    ...
    <div id="about-us-link" class="page-section grey-light-bg clearfix">
        <div class="fes7-img-cont col-md-5">
            <div class="fes7-img" style="background-image: url(images/otros_1.jpg)"></div>
        </div>

        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-6 fes7-text-cont p-80-cont">
                    <h1><span class="font-light">¿QUÉ OTROS SEGUROS OFRECEMOS?</span></h1>
                    <p class="mb-60">

                        Vivir tranquilos es lo más importante por eso nosotros te asesoramos para protegerte, cuéntanos
                        que quieres asegurar, nosotros te decimos cual es el producto que se ajusta a tus necesidades y
                        entregamos las mejores ofertas
                    </p>

                    <h2><span class="font-light">¿CÓMO TE PODEMOS AYUDAR?</span></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="fes7-box wow fadeIn" data-wow-delay="200ms">
                                ...
                                <h3>RESPONSABILIDAD CIVIL CONTRAACTUAL Y EXTRACONTRAACTUAL</h3>
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="fes7-box wow fadeIn" data-wow-delay="200ms">
                                ...
                                <h3>TODO RIESGO DE CONSTRUCCIÓN</h3>
                                <p></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 pb-30">
                    <h4 class="mt-0 mb-5"><span class="bold">¿QUÉ CUBRE?</span></h4>
                    <p>Escríbenos y te asesoramos en todo lo que necesites</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="fes7-img"></div>
                    </div>
                </div>

                <div class="fes7-img-cont col-md-6">
                    <div class="fes7-img" style="background-image: url(images/cotiza.jpg)"></div>
                </div>
                            ...
                            <form id="contact-form" action="php/contact-form.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-30">
                                        ...
                                        <input type="text" value="" data-msg-required="Escribe tu Nombre y tu Apellido"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-30">
                                        ...
                                        <input type="text" value=""
                                               data-msg-required="Es importante que coloques tu documento real, con este verificamos en las aseguradoras tus descuentos por no reclamaciones y buena experiencia"
                                               maxlength="100" class="controled" name="name" id="name"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-30">
                                        ...
                                        <input type="email" value="" data-msg-required="Escribe tu numero de celular"
                                               data-msg-email="Escribe tu numero de celular" maxlength="100"
                                               class="controled" name="email" id="email" placeholder="Celular" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-30">
                                        <!-- <label>Your email address *</label> -->
                                        <input type="email" value="" data-msg-required="Escribe tu correo"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-40">
                                        <!-- <label>Message *</label> -->
                                        <textarea maxlength="5000" data-msg-required="escribenos tu mensaje" rows="3"
                                                  class="controled" name="message" id="message" placeholder="Comentario"
                                                  required></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 text-center-xxs">
                                        <input type="submit" value="COTIZAR!" class="button medium black"
