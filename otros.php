                  ...
                  <li style="background:url(images/otrosp.jpg) no-repeat; background-position:50% 0">
                    <div class="container">
                      <div class="sixteen columns contain">
                        <h2 data-toptitle="48%" class="norm-43-wide text-center font-white caption-18-wide-767 flex-top-bot"><span class="slider-caption-border slider-caption-border-767">OTROS SEGUROS</span></h2>
                      </div>
                    </div><!-- End Container -->
                  </li><!-- End item -->
            ...
            <div class="row">
              <div class="col-md-6 col-md-offset-6 fes7-text-cont p-80-cont">
                ...
                <p class="mb-60">
                  ...
                  Vivir tranquilos es lo más importante por eso nosotros te asesoramos para protegerte, cuéntanos que quieres  asegurar, nosotros te decimos cual es el producto que se ajusta a tus necesidades y entregamos las mejores ofertas
                </p>
                  ...
                  <div class="">
                    <form id="contact-form" action="php/contact-form.php" method="POST">
                      ...
                      <div class="row">
                        <div class="col-md-12 mb-30">
                          <!-- <label>Your name *</label> -->
                          <input type="text" value="" data-msg-required="Es importante que coloques tu documento real, con este verificamos en las aseguradoras tus descuentos por no reclamaciones y buena experiencia" maxlength="100" class="controled" name="name" id="name" placeholder="Cédula" required>
                        </div>
                      </div>
                      ...
                      <div class="row">    
                        <div class="col-md-12 mb-30">
                          ...
                          <input type="email" value="" data-msg-required="Escribe tu numero de celular" data-msg-email="Escribe tu numero de celular" maxlength="100" class="controled" name="email" id="email" placeholder="Celular" required>
                          </div>
                      </div>
