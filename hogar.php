      ...
      <div id="loader3">Please enable JS</div>
            ...
            <div class="flex-container">
              <div class="flexslider loading">
                <ul class="slides">
                  ...
                  <!-- SLIDE 1 -->  
                  <li style="background:url(images/hogarp.jpg) no-repeat; background-position:50% 0">
                    <div class="container">
                      <div class="sixteen columns contain">
                        <h2 data-toptitle="48%" class="norm-43-wide text-center font-white caption-18-wide-767 flex-top-bot"><span class="slider-caption-border slider-caption-border-767">SEGURO PARA HOGAR</span></h2>
                      </div>
                    </div><!-- End Container -->
                  </li><!-- End item -->
        ...
        <div id="about-us-link" class="page-section grey-light-bg clearfix">
          <div class="fes7-img-cont col-md-5">
            <div class="fes7-img" style="background-image: url(images/hogar_1.jpg)"></div>
          </div>
          
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-offset-6 fes7-text-cont p-80-cont">
                <h1><span class="font-light">¿QUÉ ES EL SEGURO PARA HOGAR?</span></h1>
                <p class="mb-60">
                  Es un seguro voluntario que busca proteger tu vivienda;  apartamentos , casas o  inclusive fincas con   todos sus contenidos contra cualquier eventualidad  que se pueda presentar a consecuencia  de accidentes, fenómenos de la naturaleza o actos de terceros. 
                </p>

                <h2><span class="font-light">¿CÓMO LO PUEDES ASEGURAR?</span></h2>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="fes7-box wow fadeIn" data-wow-delay="200ms">
                      ...
                      <h3>SÓLO LOS CONTENIDOS DEL INMUEBLE </h3>
                      <p></p>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="fes7-box wow fadeIn" data-wow-delay="400ms">
                      ...
                      <h3>EL INMUEBLE Y LOS CONTENIDOS</h3>
                      <p></p>
                    </div>
                  </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-9 pb-30">
                ...
                <span>• Incendio y/o rayo, explosión, vientos fuertes, granizo, impacto de aeronaves y vehículos, humo, daños por agua, anegación, deslizamiento, avalancha, vendaval.</span>
                <p>•  Terremoto, temblor y/o erupción volcánica, maremoto</p>
                <p>•  Daño interno equipo electrónico y electrónico</p>
                <p>•  Hurto calificado y hurto</p>
