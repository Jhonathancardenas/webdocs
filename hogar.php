                                ...
                                <div class="container">
                                    <div class="sixteen columns contain">
                                        <h2 data-toptitle="48%"
                                            ...
                                            <span class="slider-caption-border slider-caption-border-767">SEGURO PARA HOGAR</span>
                                        </h2>
                                    </div>
                                </div><!-- End Container -->
                            </li><!-- End item -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-6 fes7-text-cont p-80-cont">
                    ...
                    <p class="mb-60">
                        Es un seguro voluntario que busca proteger tu vivienda; apartamentos , casas o inclusive fincas
                        con todos sus contenidos contra cualquier eventualidad que se pueda presentar a consecuencia de
                        accidentes, fenómenos de la naturaleza o actos de terceros.
                    </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 pb-30">
                    ...
                    <p>• Hurto calificado y hurto simple</p>
