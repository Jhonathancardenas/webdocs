                                ...
                                <div class="container">
                                    <div class="sixteen columns contain">
                                        <h2 data-toptitle="48%"
                                            ...
                                            <span class="slider-caption-border slider-caption-border-767">SEGURO DE  VIDA </span>
                                        </h2>
                                    </div>
                                </div><!-- End Container -->
                            </li><!-- End item -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-6 fes7-text-cont p-80-cont">
                    ...
                    <p class="mb-60">
                        El seguro de vida busca proteger a tu grupo grupo familiar en caso sufrir una incapacidad total
                        y permanente, la aseguradora entregara una indemnización garantizando unos ingresos para
                        resarcir las pérdidas económicas sufridas por la muerte o la incapacidad total y permanente de
                        tu familiar
                    </p>
